            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <p class="card-text"><strong>Company Name   : {{ $user->employer->company_name }}</strong></p>
                                <p class="card-text"><strong>Mission   : {{ $user->employer->mission }}</strong></p>
                    ...
                    <div class="card-footer">
                        <a href="{{ route('employer.edit.profile', ['id' => $user->id]) }}" class="btn btn-primary">Edit Profile</a>
                    </div>
                </div>
            </div>
        </div>
